...
# ck-tasks
$(BIN_DIR)/ck-tasks: src/ck-tasks/ck-tasks.c src/ck-tasks/ck-tasks-ctrl.c src/ck-tasks/ck-tasks-model.c src/ck-tasks/ck-tasks-ui.c src/ck-tasks/ck-tasks-tab-processes.c src/ck-tasks/ck-tasks-tab-applications.c src/ck-tasks/ck-tasks-tab-performance.c src/ck-tasks/ck-tasks-tab-networking.c src/ck-tasks/ck-tasks-tab-simple.c src/ck-tasks/ck-tasks-ui-helpers.c src/ck-load/vertical_meter.c src/shared/session_utils.c src/shared/session_utils.h src/shared/about_dialog.c src/shared/about_dialog.h src/shared/table/table_widget.c src/shared/gridlayout/gridlayout.c | $(BIN_DIR)
	$(CC) $(CFLAGS) $(CDE_CFLAGS) src/ck-tasks/ck-tasks.c src/ck-tasks/ck-tasks-ctrl.c src/ck-tasks/ck-tasks-model.c src/ck-tasks/ck-tasks-ui.c src/ck-tasks/ck-tasks-tab-processes.c src/ck-tasks/ck-tasks-tab-applications.c src/ck-tasks/ck-tasks-tab-performance.c src/ck-tasks/ck-tasks-tab-networking.c src/ck-tasks/ck-tasks-tab-simple.c src/ck-tasks/ck-tasks-ui-helpers.c src/ck-load/vertical_meter.c src/shared/session_utils.c src/shared/about_dialog.c src/shared/table/table_widget.c src/shared/gridlayout/gridlayout.c -o $@ $(CDE_LDFLAGS) $(CDE_LIBS)
